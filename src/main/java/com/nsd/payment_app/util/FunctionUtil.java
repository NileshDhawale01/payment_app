package com.nsd.payment_app.util;
...
public class FunctionUtil {
	...
	/**
	 * This method will take any type list and java function and apply passed
	 ...
	 * @param list
	 * @param function
	 * @return null if passed list or function is null. Otherwise list evaluated by
	 *         function
	 * @since version 1.0
	 */
	public static <T, R> List<R> eval(List<T> list, Function<T, R> function) {
		return isNull(list) || list.isEmpty() ? Collections.emptyList()
				: list.stream().map(function).distinct().collect(toList());
	}
	...
	public static <T> Object mergeEntityAndDTO(Object entity, Object dto) {
